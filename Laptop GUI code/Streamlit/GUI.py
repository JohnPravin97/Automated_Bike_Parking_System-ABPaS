...
with st.expander("Facility Viz:"):
    ...
    with col1:
        ...
        if picks == "RaspberryPi_Data":
            path = r"C:\Users\johnp\Desktop\John - Studies\University of Stuttgart - New\Smart Cities and Internet of Things\RPi Sub Code\RaspberryPi_Json_Data"
    ...
    with col2:
        ...
        if picks == "BCV_Data":
            path = r"C:\Users\johnp\Desktop\John - Studies\University of Stuttgart - New\Smart Cities and Internet of Things\RPi Sub Code\BCV1_Json_Data"
